              ...
              <table class="display table align-items-center table-flush table-hover" id="dataTableHover">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><i id='editButton' data-student-id="{{$student['id_account']}}" class='red-icon fas fa-fw fa-ban'></i></td>
                    <td><i id='deleteButton' data-student-id="{{$student['id_account']}}" data-student-full_name="{{$student['first_name']}}   {{$student['last_name']}}" data-toggle="modal" data-target="#exampleModal" class='greensq-icon fas fa-fw fa-check'></i></td>
