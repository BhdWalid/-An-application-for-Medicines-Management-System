...
<div class="container-fluid" id="container-wrapper">
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Manage Accounts Requests</h1>
    <ol class="breadcrumb">
      <li class="breadcrumb-item"><a href="{{route('dashboard')}}">Home</a></li>
      <li class="breadcrumb-item active" aria-current="page">Manage Accounts Requests</li>
    </ol>
  </div>
  <!-- Container Form -->
  <div class="row">
              ...
              <table class="display table align-items-center table-flush table-hover" id="dataTableHover">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><i id='editButton' data-student-id="{{$student['id_account']}}" class="green-icon fas fa-fw fa-check"></i></td>
                    <td><i id='deleteButton' data-student-id="{{$student['id_account']}}" data-student-full_name="{{$student['first_name']}}   {{$student['last_name']}}" data-toggle="modal" data-target="#exampleModal" class='red-icon fas fa-fw fa-times'></i></td>
...
<script>
  $(document).ready(function() {
    ...
    $(document).on("click", "#deleteButton", function() {
      ...
      var YOUR_MESSAGE_STRING_CONST = `Do You want to Delete Account <b>${full_name}</b>`;
