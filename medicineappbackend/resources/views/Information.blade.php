                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="login-form">
                                        ...
                                        <div class="dash">
                                            <h1 class="h1 text-gray-900 mb-4" style="font-size: 3.5rem; position: absolute; top: 28%; left: 44%; transform: translate(-50%, -50%);">Admin Profile</h1>
                                            ...
                                            <div class="container">
                                                ...
                                                <div class="decorated-space">
                                                    <div class="info">
                                                        <span>First Name:</span> Bouhaddi
                                                    </div>
                                                    <div class="info">
                                                        <span>Last Name:</span>Oualid
                                                    </div>
                                                    <div class="info">
                                                        <span>Email:</span> oualidbouhaddi1@gmail.com
                                                    </div>
                                                    <div class="info">
                                                        <span>Phone Number:</span> 0641229461
                                                    </div>
                                                    <div class="info">
                                                        <span>Address:</span> Cite Boussouf
                                                    </div>
                                                    <div class="info">
                                                        <span>Role:</span> Create accounts
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
